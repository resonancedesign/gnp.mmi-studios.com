<?php
    ...
    $query = mysqli_query($myConnection, "INSERT INTO mmi_customers (customerName, customerEmail, customerAddress1, customerAddress2, customerCity, customerState, customerZip, customerCountry, customerStripe, orderSummary) 
